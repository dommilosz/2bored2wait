...
7. For trust reasons, this tool does not update automatically. Check back here once in a while to see if there are any updates or run download-and-run.js to update and run automatically.
